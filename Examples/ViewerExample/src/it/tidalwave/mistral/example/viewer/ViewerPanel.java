 ...
 *******************************************************************************
 * 
 * $Id: ViewerPanel.java 513 2007-03-16 21:31:26Z fabriziogiudici $
 * 
 ******************************************************************************/
 ...
 * @version $Id: ViewerPanel.java 513 2007-03-16 21:31:26Z fabriziogiudici $
 *
 ******************************************************************************/
...
//        imageRenderer.setScaledImageCachingEnabled(true); FIXME - doesn't work
    ...
    private void initComponents() {
        ...
        btZoomIn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tidalwave/mistral/example/viewer/icons/viewmag+.png")));
        ...
        btActualPixels.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tidalwave/mistral/example/viewer/icons/viewmag1.png")));
        ...
        btZoomOut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tidalwave/mistral/example/viewer/icons/viewmag-.png")));
        ...
        btFitToWindow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tidalwave/mistral/example/viewer/icons/viewmagfit.png")));
