...
public abstract class BaseTestSupport
  {
    ...
    protected static File imageFolder = new File(System.getProperty("org.imajine.image.test.folder", ""));
        ...
        if (!imageFolder.exists())
          {
            ...
            System.err.printf("org.imajine.image.test.folder not defined, using %s\n", imageFolder);
