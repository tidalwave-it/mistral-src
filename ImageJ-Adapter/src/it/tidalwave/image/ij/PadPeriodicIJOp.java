...
public class PadPeriodicIJOp extends OperationImplementation<PadPeriodicOp, ImagePlus>
  {
    private static final String CLASS = PadPeriodicIJOp.class.getName();
     ...
     *
     ******************************************************************************/
    protected ImagePlus execute (PadPeriodicOp operation, final EditableImage image, ImagePlus imagePlus)
      {
